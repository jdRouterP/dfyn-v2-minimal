...
import { Vault, ERC20Mock, TridentRouter, WETH9 } from "../../types";
...
describe("Router", function () {
  ...
  describe("#exactInputSingle", function () {
    ...
    it("Reverts when output is less than minimum", async () => {
      ...
      const bento = await ethers.getContract<Vault>("Vault");
  ...
  describe("#addLiquidity", function () {
    it("Reverts when not enough liquidity is minted", async () => {
      ...
      const bentoBox = await ethers.getContract<Vault>("Vault");
