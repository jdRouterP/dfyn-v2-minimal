...
export default function Createpool() {
  const TWO_POW_96 = BigNumber.from(2).pow(96);
    ...
    const { tokenA,tokenB,price,tokenAAmount,tokenBAmount,fee,tickSpacing,error, success } = values;
  ...
  async function deployPool() {
    if (active) {
      ...
      const masterDeployer = new ethers.Contract(MasterDeployer,masterDeployerAbi, signer);
      ...
      <h1>Create Pool</h1>
        <div className="card">
          <div className="card-body">
            <form>
              <div className="mb-3">
                <label htmlFor="exampleInputEmail1" className="form-label">TokenA</label>
              ...
              <div className="mb-3">
                <label htmlFor="exampleInputEmail1" className="form-label">TokenB</label>
                <input  className="form-control"
              ...
              <div className="mb-3">
                <label htmlFor="exampleInputPassword1" className="form-label">tickSpacing</label>
                <input  className="form-control"
                onChange={handleChange("tickSpacing")}
                type="text"
                value={tickSpacing} />
              </div>
              {active ? <button type="button" className="btn btn-primary " onClick={() => deployPool()}>Create</button> : ""}
            </form>
          </div>
        </div>
      </div>
