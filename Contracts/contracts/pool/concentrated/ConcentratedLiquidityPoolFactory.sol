...
/// @author Mudit Gupta.
contract ConcentratedLiquidityPoolFactory is Ownable, PoolDeployer {
    ...
    function updateSwapFee(address pool, uint24 swapFee) external onlyOwner {
        IConcentratedLiquidityPool(pool).updateSwapFee(swapFee);
    }
}
